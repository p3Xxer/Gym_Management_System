...
export class Repulser extends ExternalInteractorBase {
    ...
    clickRepulse() {
        ...
        if (container.repulse.clicking) {
            ...
            for (const particle of query) {
                const { dx, dy, distance } = getDistances(mouseClickPos, particle.position), d = Math.pow(distance, 2), velocity = container.actualOptions.interactivity.modes.repulse.speed, force = (-repulseRadius * velocity) / d;
                if (d <= repulseRadius) {
